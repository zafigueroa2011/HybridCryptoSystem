...
public class CryptoSysApplication {
    ...
    /**
     * Encrypts message using ElGamal and DES
     * Uses secret key message and ElGamal to create key
     * Then uses encrypted key to encrypt the message using DES.
    ...
    /**
     * Decrypts message using ElGamal and DES
     * Uses secret key message and ElGamal to create key
     * Then uses encrypted key to encrypt the message using DES.
     * @param key key generator object.
     ...
     * @return -1 if the ciphertext and secretKey are not empty. Otherwise returns 0.
     */
